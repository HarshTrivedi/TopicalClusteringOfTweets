...
c1 <- (as.list(((which(results$cluster == 1) ))))
c2 <- (as.list(((which(results$cluster == 2) ))))
c3 <- (as.list(((which(results$cluster == 3) ))))
c4 <- (as.list(((which(results$cluster == 4) ))))
c5 <- (as.list(((which(results$cluster == 5) ))))
c6 <- (as.list(((which(results$cluster == 6) ))))
...
negative_pairs <- choose( length(results$cluster) , 2) - positive_pairs
...
purity_denominator <- length(results$cluster)
